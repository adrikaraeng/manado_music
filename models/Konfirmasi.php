...
class Konfirmasi extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ip', 'no_transaksi', 'nama_pelanggan', 'no_telepon',  'tanggal_pesan', 'tanggal_expired', 'status', 'wilayah', 'alamat_lengkap', 'jasa'], 'required', 'message'=> ''],
            ...
            [['ip', 'no_transaksi', 'nama_pelanggan', 'no_telepon', 'no_rek_pelanggan', 'rek_a_n', 'bank', 'struk_bukti', 'tanggal_pesan', 'tanggal_expired', 'status', 'alamat_lengkap', 'no_resi', 'jasa_pengiriman', 'wilayah', 'estimasi_hari', 'jasa'], 'string'],
            [['ongkir','jumlah_harga_item', 'berat'],'integer'],
