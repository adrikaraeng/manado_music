...
$katSQL = Jenis::find()->where("aktivasi='Aktif'")->all();
...
<div class="jenis-form col-lg-7" style="background-color:#dce3ed;padding:8px;"">
    ...
    <?php $form = ActiveForm::begin(['id' => 'form-kategori', 'options' => ['enctype' => 'multipart/form-data']]); ?>
        ...
        <?= $form->field($model, 'jenis')->dropDownList(ArrayHelper::map($katSQL, 'id',
        ...
        <?= $form->field($model, 'title')->textInput(['maxlength' => 30, 'placeholder'=>'Nama Sub Kategori (*)'])->label(false) ?>
